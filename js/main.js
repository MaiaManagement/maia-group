...
(function () {
  ...
  var translations = {
    ...
    en: {
      ...
      'about.p2': 'Each brand within our ecosystem operates independently, but shares a common philosophy: creating real opportunities, world-class services, and a positive impact on the region. Founded by British entrepreneur Andrew Gallie, The Maia Group was built as a platform — one legal entity, one AI backbone, 14 ventures.',
